---
repo: "https://github.com/IORoot/ngrok-debug-via-ssh"
slug:  "/projects/ngrok-debug-via-ssh"
date:  "2023-02-13"
title: "ngrok-debug-via-ssh"
icon:  "github"
desc:  "Here you can find a GitHub Action that allows you to connect to a GitHub Actions runner via SSH for interactive debugging using ngrok."
---
